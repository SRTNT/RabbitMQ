...
Console.Title = "Consumer - " + dmAppSetting.CoreSystemENV.environment;
...
dmSwaggerConfig.swaggerTitle = "Consumer";
...
dmAppSetting.lstRabbitMQNamespace.Add(typeof(Consumer.RabbitMQStructure.ConsumerMessage1).Namespace);
dmAppSetting.lstRabbitMQNamespace.Add(typeof(Consumer.RabbitMQStructure.ConsumerMessage2).Namespace);
#endregion
