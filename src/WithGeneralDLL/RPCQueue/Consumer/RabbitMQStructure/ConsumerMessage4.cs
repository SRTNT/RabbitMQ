...
{
    public class ConsumerMessage4 : GeneralDLL.Core.RabbitMQ.Consumer.ConsumerMessageAbstract
    {
        public ConsumerMessage4(
            AppConnectionString appConnectionString,
            ILogger<ConsumerMessage4> logger) : base(appConnectionString, logger)
        {
        }
