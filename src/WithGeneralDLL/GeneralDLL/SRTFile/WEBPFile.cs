// Ignore Spelling: luma wpic premultiplied libwebp scanline scanlines bmp PSNR palettization yuv autofilter jpeg sns argb colorspace PSNRY PSNRU PSNRV PSNRALL quant hdr RGBA YUVA upsampling
...
{
    public class WEBPFile : IDisposable
    {
        ...
        private byte[] AdvancedEncode(Bitmap bmp, WebPConfig config, bool info)
        {
            ...
            try
            {
                ...
                {
                    //Put the bitmap components in wpic
